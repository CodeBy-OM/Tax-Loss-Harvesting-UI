const holdingsData = [
  ...
  {
    coin: "WPOL",
    coinName: "Wrapped POL (v2)",
    logo: "https://koinx-statics.s3.ap-south-1.amazonaws.com/currencies/DefaultCoin.svg",
    currentPrice: 22.08,
    totalHolding: 0.5,
    averageBuyPrice: 25.0,
    stcg: { balance: 0.5, gain: -1.46 },
    ltcg: { balance: 0, gain: 0 },
  },
  {
    coin: "EZ",
  ...
  },
  {
    ...
    currentPrice: 22.22,
    totalHolding: 1.5,
    averageBuyPrice: 30.0,
    stcg: { balance: 1.5, gain: -11.67 },
    ltcg: { balance: 0.5, gain: -5.0 },
  },
  {
    coin: "FTM",
    coinName: "Fantom",
...
export const fetchHoldings = () =>
  new Promise((resolve) => setTimeout(() => resolve(holdingsData), 600));

export const fetchCapitalGains = () =>
  new Promise((resolve) => setTimeout(() => resolve(capitalGainsData), 400));
